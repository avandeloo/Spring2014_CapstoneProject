...
{
    public class SOLAR_BUS_BARN_SUM_BY_DAYMap : EntityTypeConfiguration<SOLAR_BUS_BARN_SUM_BY_DAY>
    {
        public SOLAR_BUS_BARN_SUM_BY_DAYMap()
        {
            // Primary Key
            this.HasKey(t => t.SolarBusBarnSumByDayID);

            // Properties
            // Table & Column Mappings
            this.ToTable("SOLAR_BUS_BARN_SUM_BY_DAY");
            this.Property(t => t.SolarBusBarnSumByDayID).HasColumnName("SolarBusBarnSumByDayID");
