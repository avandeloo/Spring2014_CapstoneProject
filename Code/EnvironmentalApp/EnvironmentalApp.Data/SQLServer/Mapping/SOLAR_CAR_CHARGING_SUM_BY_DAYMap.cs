...
{
    public class SOLAR_CAR_CHARGING_SUM_BY_DAYMap : EntityTypeConfiguration<SolarDailyTotals_CarCharger>
    {
        public SOLAR_CAR_CHARGING_SUM_BY_DAYMap()
        {
            ...
            this.Property(t => t.Id).HasColumnName("SolarCarChargingSumByDayID");
